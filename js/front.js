$(function() {
  ...
  /* =========================================
     ...
     *  =======================================*/
  $('.resume a').on('click', function(e) {
    e.preventDefault();

    var images = $(this)
      .siblings('.resume-description')
      .data('images')
      .split(',');
    let sliderContent = '';
    if (images.length > 0) {
    ...
    openResumeReference(sliderContent);
  });

  function openResumeReference(sliderContent) {
    $('#resume-detail').slideDown();
    $('#resume').slideUp();

    if (sliderContent !== '') {
      var slider = $('#resume-detail-slider');
  ...
  function closeResumeReference() {
    $('#resume').slideDown();
    $('#resume-detail').slideUp();
  }

  $('#resume-detail .close').on('click', function() {
    closeResumeReference();
  });
